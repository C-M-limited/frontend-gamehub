...
//             {/* Scroll Bar */}
//             <Grid item xs={12} md={12} lg={4} sx={{ height: '100vh', overflowY: 'scroll',  display: { xs: 'none', sm: 'none',md: 'none',lg:'block' }, flexDirection: 'column', alignItems: 'center' }}>
//                 <Box>
...
//                 </Grid>
//             </Grid>
//             {/* Scroll Bar show only on small window */}
//             <Grid item xs={12} md={12} lg={4} sx={{ height: '100vh', overflowY: 'scroll',  display: { xs: 'block', sm: 'block',md: 'block',lg:'none' }, flexDirection: 'column', alignItems: 'center' }} >
//                 <Box>
//                     <Image layout="intrinsic" src="/game_sample.png" width={'150px'} height={'200px'} />
//                 </Box>
//                 {Array.from(Array(9)).map((item) => {
